    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 text-balance">Your AI Career Mentor</h1>
          <p className="text-xl text-gray-600 mb-8 text-pretty max-w-2xl mx-auto">
            Discover your personalized career path and close skill gaps with AI guidance. Get tailored recommendations
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">
              Advanced algorithms analyze your skills and interests to provide personalized career recommendations.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">Get a step-by-step plan with timelines to achieve your career objectives.</p>
          </div>
        </div>
      </main>
